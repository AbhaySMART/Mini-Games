...
import { RewardSystem, SHOP_ITEMS, CURRENT_EVENT } from "../systems/RewardSystem.js?v=76";
...
export class ShopScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.panel = this.add.dom(100, 60).createFromHTML(`<div class="kk-reward-panel shop" style="width:760px; max-width:760px;"></div>`);
